...
// New code should use the PrintSelectPanel class directly.
//
...
/**
 * @deprecated Use PrintSelectPanel::init_subjects() instead
 */
[[deprecated("Use PrintSelectPanel class directly - see docs/PANEL_MIGRATION.md")]]
void ui_panel_print_select_init_subjects();

/**
 * @deprecated Use PrintSelectPanel::setup() instead
 */
[[deprecated("Use PrintSelectPanel class directly - see docs/PANEL_MIGRATION.md")]]
void ui_panel_print_select_setup(lv_obj_t* panel_root, lv_obj_t* parent_screen);

/**
 * @deprecated Use PrintSelectPanel::populate_test_data() instead
 */
[[deprecated("Use PrintSelectPanel class directly - see docs/PANEL_MIGRATION.md")]]
void ui_panel_print_select_populate_test_data(lv_obj_t* panel_root);

/**
 * @deprecated Use PrintSelectPanel::refresh_files() instead
 */
[[deprecated("Use PrintSelectPanel class directly - see docs/PANEL_MIGRATION.md")]]
void ui_panel_print_select_refresh_files();

/**
 * @deprecated Use PrintSelectPanel::toggle_view() instead
 */
[[deprecated("Use PrintSelectPanel class directly - see docs/PANEL_MIGRATION.md")]]
void ui_panel_print_select_toggle_view();

/**
 * @deprecated Use PrintSelectPanel::sort_by() instead
 */
[[deprecated("Use PrintSelectPanel class directly - see docs/PANEL_MIGRATION.md")]]
void ui_panel_print_select_sort_by(PrintSelectSortColumn column);

/**
 * @deprecated Use PrintSelectPanel::show_delete_confirmation() instead
 */
[[deprecated("Use PrintSelectPanel class directly - see docs/PANEL_MIGRATION.md")]]
void ui_panel_print_select_show_delete_confirmation();

/**
 * @deprecated Use PrintSelectPanel::set_selected_file() instead
 */
[[deprecated("Use PrintSelectPanel class directly - see docs/PANEL_MIGRATION.md")]]
...
/**
 * @deprecated Use PrintSelectPanel::show_detail_view() instead
 */
[[deprecated("Use PrintSelectPanel class directly - see docs/PANEL_MIGRATION.md")]]
void ui_panel_print_select_show_detail_view();

/**
 * @deprecated Use PrintSelectPanel::hide_detail_view() instead
 */
[[deprecated("Use PrintSelectPanel class directly - see docs/PANEL_MIGRATION.md")]]
void ui_panel_print_select_hide_detail_view();

/**
 * @deprecated Use PrintSelectPanel::set_print_status_panel() instead
 */
[[deprecated("Use PrintSelectPanel class directly - see docs/PANEL_MIGRATION.md")]]
