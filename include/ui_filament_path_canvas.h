...
/**
 * @brief Set the slot overlap amount for gate X position calculation
 *
 * When slots use negative column padding to overlap visually (for 5+ gates),
...
/**
 * @brief Set the slot width for gate X position calculation
 *
