...
// ============================================================================
// CHARACTERIZATION: Observer Callback Behavior
// ============================================================================

TEST_CASE_METHOD(LVGLTestFixture, "CHAR: Observer callback triggered on subject change",
    ...
    // [L049]: Release observer BEFORE subject deinit
    guard.release();
    lv_subject_deinit(&subject);
}

TEST_CASE_METHOD(LVGLTestFixture, "CHAR: LVGL optimizes out unchanged value callbacks",
                 "[characterization][observer]") {
    // LVGLTestFixture handles initialization
    ...
    ObserverGuard guard(&subject, cb, &callback_count);
    callback_count = 0; // Reset after initial callback
